...
export default function Home() {
  ...
  const mockProducts: Product[] = [
    ...
    },
    {
      ...
      image: "⌨️",
      rating: 4.7,
      stock: 0 // Out of stock to test badge
    },
    {
      id: "prod_4",
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 flex flex-col font-sans relative">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="relative p-2 rounded-lg bg-zinc-900/80 hover:bg-zinc-800/80 border border-zinc-800 transition-all group"
            >
              🛒
              {cartCount > 0 && (
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-12 md:py-20 z-10 w-full">
        ...
        <section className="text-center max-w-3xl mx-auto mb-20 flex flex-col items-center">
          <div className="inline-flex items-center gap-2 bg-indigo-950/40 text-indigo-300 border border-indigo-900/50 px-4 py-1.5 rounded-full text-xs font-semibold mb-6">
            ✨ Module 1 Complete: Next.js Foundation & Core CSS Design System
          </div>
        ...
        <section id="roadmap" className="mb-24 scroll-mt-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <div className="text-xs bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-2 mt-4 md:mt-0 max-w-fit">
              Current Branch: <code className="text-indigo-400 font-mono">module-1-foundation</code>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-panel rounded-2xl p-6 relative overflow-hidden group">
              ...
              <p className="text-zinc-400 text-xs leading-relaxed mb-4">
                Boilerplate initialization using TypeScript, React 19, and Tailwind v4. Established the HSL color variables and glassmorphism styling toolkit.
              </p>
              <div className="text-[10px] font-mono text-zinc-500">
                Modified: app/page.tsx, globals.css, context.md
              </div>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden group">
              ...
              <h3 className="font-bold text-lg text-white/80 mb-2">Module 2: Neon DB & Prisma</h3>
              <p className="text-zinc-500 text-xs leading-relaxed mb-4">
                Provision PostgreSQL with serverless Neon DB. Design a type-safe schema with Users, Products, Categories, Orders, and Items. Create seed scripts.
              </p>
              <div className="text-[10px] font-mono text-zinc-600">
                Target: prisma/schema.prisma, lib/prisma.ts
              </div>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden group">
              ...
              <h3 className="font-bold text-lg text-white/80 mb-2">Module 3: NextAuth Security</h3>
              <p className="text-zinc-500 text-xs leading-relaxed mb-4">
              ...
              <div className="text-[10px] font-mono text-zinc-600">
                Target: middleware.ts, app/api/auth/*
              </div>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden group">
              ...
              <div className="text-[10px] font-mono text-zinc-600">
                Target: lib/stripe.ts, app/api/payments/*
              </div>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden group">
              ...
              <h3 className="font-bold text-lg text-white/80 mb-2">Module 4: Admin & Cloudinary</h3>
              <p className="text-zinc-500 text-xs leading-relaxed mb-4">
                Create full admin CRUD control. Hook up the Cloudinary upload API preset to transform and store high-resolution optimized webp product images.
              </p>
              <div className="text-[10px] font-mono text-zinc-600">
                Target: app/(admin)/*, lib/cloudinary.ts
              </div>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden group">
              ...
              <div className="text-[10px] font-mono text-zinc-600">
                Target: app/api/ai/chat/*, components/ChatDrawer
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="store" className="scroll-mt-24 mb-20">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">Mock Catalog Preview</h2>
              <p className="text-zinc-400 text-sm mt-2">Test adding premium items. All state operates reactively to prepare for Zustand.</p>
            </div>
            <div className="text-xs text-zinc-400 font-semibold bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-2">
              Zustand Cart Integration: <span className="text-emerald-400">Mocked</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {mockProducts.map(product => (
              <div key={product.id} className="glass-panel rounded-2xl overflow-hidden hover:scale-[1.02] hover:border-indigo-500/40 transition-all duration-300 flex flex-col group h-full">
                ...
                {/* Product Image Panel */}
                <div className="h-48 bg-zinc-950 border-b border-zinc-800/80 flex items-center justify-center text-6xl relative select-none">
                  {product.image}
                  {product.stock === 0 && (
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="font-bold text-white mt-1 group-hover:text-indigo-400 transition-colors">
                      {product.name}
                    </h3>
      ...
      {/* Cart Sidebar Panel (Zustand State Simulation) */}
      {isCartOpen && (
            ...
            <div className="w-screen max-w-md glass-panel flex flex-col h-full shadow-2xl animate-fade-in border-l border-zinc-800">
              ...
              <div className="px-6 py-5 border-b border-zinc-800 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="p-1.5 rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all text-xs"
                >
                  ✕ Close
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                {cartItems.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center text-zinc-500">
                    ...
                    <p className="text-xs mt-1">Add items from the preview catalog to start shopping!</p>
                  </div>
                ) : (
                  cartItems.map(item => (
                    <div key={item.product.id} className="flex items-center gap-4 bg-zinc-900/50 border border-zinc-900 p-3 rounded-xl">
                      <div className="w-12 h-12 rounded-lg bg-zinc-950 flex items-center justify-center text-2xl">
                        {item.product.image}
                      </div>
      ...
      {/* Floating AI Chat Assistant Drawer (Module 9 Cognitive Support Simulation) */}
